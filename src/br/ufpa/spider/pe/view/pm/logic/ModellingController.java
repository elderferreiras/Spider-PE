...
import br.ufpa.spider.pe.view.pm.gui.BasicPropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.ComponentWithFilePropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.DisciplinePropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.Graph;
import br.ufpa.spider.pe.view.pm.gui.GraphComponent;
import br.ufpa.spider.pe.view.pm.gui.MilestonePropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.NameAndDescriptionPropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.PhasePropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.RelationshipPropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.RoleDefinitionPropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.RoleUsePropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.TaskDefinitionPropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.TaskUseFeedBackPanel;
import br.ufpa.spider.pe.view.pm.gui.TaskUsePropertiesPanel;
import br.ufpa.spider.pe.view.pm.gui.View;
import br.ufpa.spider.pe.view.pm.gui.WorkPropertiesPanel;
...
import br.ufpa.spider.pe.view.pm.model.RelationshipType;
...
protected static boolean taskExtensaoComponentsExecutar(Tarefa tarefa, String label, String fork, String estadoAnteior, String estadoRequisitado) {
    ...
    protected static void saveBarra(String string) {
        ...
        joinfork.setProcessId(JDialog_Spider_Login.getInstance().Spider_PE_Home
                .getProcesso().getId());
    ...
    protected static void saveTransicao(String tipoTransicao) {
        ...
        if(Modelling.getModelling().getComponent(transicao.getDestinationId()).getType().equals(ComponentType.DECISION_AND_MERGE))
            ...
            trans.setTipo("\n"+tipoTransicao);
        trans.setProcessId(JDialog_Spider_Login.getInstance().Spider_PE_Home
                .getProcesso().getId());
        try {
