...
//		((jPanelPropertiesPrevivedAndReal)panel_1).setInformacoes(inicioPrevisto, inicioReal, terminoPrevisto, terminoReal, cargaPrevista, cargaReal);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(br.ufpa.spider.pe.view.pm.gui.Application.class).getContext().getResourceMap(PhasePropertiesPanel.class);
