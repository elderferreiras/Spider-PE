...
public class ComponentWithFilePropertiesPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(br.ufpa.spider.pe.view.pm.gui.Application.class).getContext().getResourceMap(ComponentWithFilePropertiesPanel.class);
                ...
                try {
                    ...
                    if (desktop.isSupported(Desktop.Action.BROWSE)) {
                        try {
                            ...
                            JOptionPane.showMessageDialog(JDialog_Spider_Login.view.getMainPanel(),
