...
import br.ufpa.spider.pe.view.management.Progress;
...
public class JPanelImportarXML extends JPanel {
	...
	public JPanelImportarXML() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(JPanelImportarXML.class.getResource("/br/ufpa/spider/pe/view/util/img/spider-pm.png")));
