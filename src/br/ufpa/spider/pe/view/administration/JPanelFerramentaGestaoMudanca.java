...
public class JPanelFerramentaGestaoMudanca extends JPanel {
	...
	public JPanelFerramentaGestaoMudanca() {
		...
		lblNewLabel.setIcon(new ImageIcon(JPanelFerramentaGestaoMudanca.class.getResource("/br/ufpa/spider/pe/view/util/img/Subversion.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(JPanelFerramentaGestaoMudanca.class.getResource("/br/ufpa/spider/pe/view/util/img/redmine.png")));
