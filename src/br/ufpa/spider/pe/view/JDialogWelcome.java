...
public class JDialogWelcome extends JFrame {
	...
	public JDialogWelcome() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(JDialogWelcome.class.getResource("/br/ufpa/spider/pe/img/config/favicon_pe.png")));
		setTitle("Spider-PE");
		try {
		...
		label.setIcon(new ImageIcon(JDialogWelcome.class.getResource("/br/ufpa/spider/pe/img/splash-screen.png")));
