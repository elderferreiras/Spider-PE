...
public class Icone {
	...
	public ImageIcon getSpider_ucp() {
		return spider_ucp;
	}

	public ImageIcon getSpider_cocom() {
		return spider_cocom;
	}
	public ImageIcon getBaixar() {
		return baixar;
	}
	...
	public ImageIcon getForm() {
		return form;
	}

	public ImageIcon getHistory() {
		return history;
	}
	...
	public ImageIcon getLogo_spider_pe() {
		return logo_spider_pe;
	}


	public ImageIcon getLogout() {
		return logout;
	}

	public ImageIcon getProcess() {
		return process;
	}
	...
	public ImageIcon getFolder_open() {
		return folderOpen;
	}

	public ImageIcon getSpider_cl() {
		return spider_cl;
	}

	public ImageIcon getSpider_mplan() {
		return spider_mplan;
	}
	
	public ImageIcon getPdf() {
		return pdf;
	}
	public void setPdf(ImageIcon pdf) {
		this.pdf = pdf;
	}
	public ImageIcon getXls() {
		return xls;
	}
	public void setXls(ImageIcon xls) {
		this.xls = xls;
	}
	public ImageIcon getPpt() {
		return ppt;
	}
	public void setPpt(ImageIcon ppt) {
		this.ppt = ppt;
	}
	public ImageIcon getDoc() {
		return doc;
	}
	public void setDoc(ImageIcon doc) {
		this.doc = doc;
	}
	public ImageIcon getJar() {
		return jar;
	}
	public void setJar(ImageIcon jar) {
		this.jar = jar;
	}
	public ImageIcon getJava() {
		return java;
	}
	public void setJava(ImageIcon java) {
		this.java = java;
	}
	...
	public ImageIcon getFolderOpen() {
		return folderOpenRepo;
	}
	public void setFolderOpen(ImageIcon folderOpen) {
		this.folderOpenRepo = folderOpen;
	}
	public ImageIcon getFolderClosed() {
		return folderClosed;
	}
	public void setFolderClosed(ImageIcon folderClosed) {
		this.folderClosed = folderClosed;
	}
	public void setFolderEnd(ImageIcon folderEnd) {
		this.folderEnd = folderEnd;
	}
	public ImageIcon getFolderEnd() {
		return folderEnd;
	}
	public void setTxt(ImageIcon txt) {
		this.txt = txt;
	}
	public ImageIcon getTxt() {
		return txt;
	}
	public void setZip(ImageIcon zip) {
		this.zip = zip;
	}
	public ImageIcon getZip() {
		return zip;
	}
	public void setNadadentro(ImageIcon nadadentro) {
		this.nadadentro = nadadentro;
	}
	public ImageIcon getNadadentro() {
		return nadadentro;
	}
	...
	public void setTool(ImageIcon tool) {
		this.tool = tool;
	}

	public ImageIcon getTool_icon() {
		return tool_icon;
	}

	public void setTool_icon(ImageIcon tool_icon) {
	...
	public void setClear(ImageIcon clear) {
		this.clear = clear;
	}
	...
	public void setSalvar(ImageIcon salvar) {
		this.salvar = salvar;
	}

	public ImageIcon getPdf_download() {
		return pdf_download;
	}

	public void setPdf_download(ImageIcon pdf_download) {
		this.pdf_download = pdf_download;
	}

	public ImageIcon getConversion() {
		return conversion;
	}

	public void setConversion(ImageIcon conversion) {
