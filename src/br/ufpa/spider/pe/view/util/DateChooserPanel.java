...
public class DateChooserPanel extends JPanel implements PropertyChangeListener {
	...
	public DateChooserPanel() {
		...
		gridbag.rowWeights = new double[]{0.0};
		gridbag.rowHeights = new int[]{59};
		gridbag.columnWeights = new double[]{0.0};
		...
		addEntry(components[1], gridbag);		
	}

	private void addEntry(JComponent component, GridBagLayout grid) {
