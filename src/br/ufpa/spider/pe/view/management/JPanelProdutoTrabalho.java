...
public class JPanelProdutoTrabalho extends JPanel {
	...
	public JPanelProdutoTrabalho() {
		...
		button.setIcon(new ImageIcon(JPanelProdutoTrabalho.class.getResource("/br/ufpa/spider/pe/view/util/img/logo_spider-qa.png")));
		toolBar.add(button);
		...
		button_1.setIcon(new ImageIcon(JPanelProdutoTrabalho.class.getResource("/br/ufpa/spider/pe/view/util/img/spider_cl.png")));
