...
public class JPanelRevisaoProdutoTrabalho extends JPanel {
	...
	private List<ProdutoTrabalho> getListProdutoTrabalhos(){
		...
		if(Spider_PE_Home.getInstance().Spider_PE_Management.getProcesso().getPoliticaOrganizacional()!=null)
			produtos.add(Spider_PE_Home.getInstance().Spider_PE_Management.getProcesso().getPoliticaOrganizacional().getProdutoTrabalho());
		
		if(Spider_PE_Home.getInstance().Spider_PE_Management.getProcesso().getPlanoMedicao()!=null)
			produtos.add(Spider_PE_Home.getInstance().Spider_PE_Management.getProcesso().getPlanoMedicao().getProdutoTrabalho());
