...
public class ExecutionController {
	...
	public static String getEstadoProcesso(Component component) {
		...
		if(Spider_PE_Home.getInstance().getLogado() == Spider_PE_Home.getInstance().GERENTE){
			 processo = Spider_PE_Home.getInstance().Spider_PE_Management.getProcesso();
		 } else if(Spider_PE_Home.getInstance().getLogado() == Spider_PE_Home.getInstance().RH){
			 processo = Spider_PE_Home.getInstance().execution.getProcesso();
		 }
		if(processo!=null){
	...
	public static String getEstadoMarco(
			br.ufpa.spider.pe.view.execution.model.Component component) {
