...
public class NameAndDescriptionPropertiesPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(br.ufpa.spider.pe.view.execution.gui.Application.class).getContext().getResourceMap(NameAndDescriptionPropertiesPanel.class);
