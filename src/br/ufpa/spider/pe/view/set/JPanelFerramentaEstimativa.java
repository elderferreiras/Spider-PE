...
public class JPanelFerramentaEstimativa extends JPanel {
	...
	public JPanelFerramentaEstimativa() {
		...
		lblNewLabel.setIcon(new ImageIcon(JPanelFerramentaEstimativa.class.getResource("/br/ufpa/spider/pe/img/logo_spider-apf.png")));
		...
		label.setIcon(new ImageIcon(JPanelFerramentaEstimativa.class.getResource("/br/ufpa/spider/pe/img/config/logo_spider-ucp.png")));
		...
		label_1.setIcon(new ImageIcon(JPanelFerramentaEstimativa.class.getResource("/br/ufpa/spider/pe/img/logo_spider-cocomo.png")));
